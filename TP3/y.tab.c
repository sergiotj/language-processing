...
{
  "$end", "error", "$undefined", "OBJECT_TYPE", "STRING", "OBJECT_ID",
  "ATTRIBUTE", "PARTICIPOU", "ESTREOU", "ERR", "$accept", "Objects",
  "Object", "Fields", "Field", "Connection", YY_NULLPTR
};
#endif
...
#line 1242 "y.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 44 "filmes.y" /* yacc.c:1646  */
    { char* one = strdup((yyvsp[-2].str)); char* three = strdup((yyvsp[0].str)); char* f = "participou"; g_array_append_val(edge_data, one); g_array_append_val(edge_data, three); g_array_append_val(edge_data, f); }
#line 1248 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 45 "filmes.y" /* yacc.c:1646  */
    { char* one = strdup((yyvsp[-2].str)); char* three = strdup((yyvsp[0].str)); char* p = "estreou"; g_array_append_val(edge_data, one); g_array_append_val(edge_data, three); g_array_append_val(edge_data, p); }
